...
const config = (): AppConfig => ({
  tenantId: 'test', awsRegion: 'ca-central-1', creators: 'creators', groupingsTable: 'groupings', imagesTable: 'images', commentsTable: 'comments', favoritesTable: 'favorites', blockedUsersTable: 'blocked', siteSettingsTable: 'settings', contentStatsTable: 'stats', trendingFeedTable: 'trending', contentCoreTable: 'core', useContentCoreTable: false, mediaBucket: 'media', unlockJwtSecret: 'unlock', unlockTokenTtlSeconds: 3600, rememberGroupingAccessTtlSeconds: 3600, signedUrlTtlSeconds: 300, trendingFeedMaxItems: 100, trendingCandidateLimit: 100, externalSyncBaseDelaySeconds: 60, deviantArtMinimumRequestIntervalMs: 0, youtubeMinimumRequestIntervalMs: 0, youtubeApiBaseUrl: 'https://www.googleapis.com/youtube/v3', externalScheduledScansEnabled: false, externalAccountScanIntervalSeconds: 100, externalActivityScanIntervalSeconds: 100, deviantArtPublishedDescriptionUpdate: false, externalContentMaxBytes: 1_000_000, externalTokenEncryptionKey: 'encryption-key', discordApiBaseUrl: 'https://discord.com/api/v10', wordpressApprovedEmbedHosts: [], wordpressManagedSiteHosts: [], wordpressBlockedSiteHosts: [], flickrMinimumRequestIntervalMs: 0, tumblrClientId: 'managed-client', tumblrClientSecret: 'managed-secret', tumblrOAuthRedirectUri: 'https://api.example/integrations/tumblr/callback', tumblrApiBaseUrl: 'https://api.tumblr.com', tumblrMediaBlockLimit: 10, tumblrHourlyRequestLimit: 1000, tumblrDailyRequestLimit: 5000, tumblrPublishMaxAttempts: 5, tumblrRetryBaseDelaySeconds: 60
});
