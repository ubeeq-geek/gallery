...
export const integrationCapabilities: Record<IntegrationPlatformId, IntegrationCapabilityDeclaration> = {
  ...
  bluesky: { platform: 'bluesky', import: false, sourceCopy: false, publish: { image: true, video: true }, update: true, delete: true, collections: false, comments: true, analytics: false, aiLabel: { read: false, write: false, carouselPrecision: 'none' }, scheduling: false, rateLimits: true },
